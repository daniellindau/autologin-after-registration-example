    ...
    : RegistrationRequestHandler<RegistrationRequestModel>
{
            ...
            Optional<RegistrationResult>
    {
        response.setResponseModel(templateResponseModel(emptyMap(),
                "templates/authenticator/autologin/resources/register/get"), NOT_FAILURE)
    ...
    override fun post(model: RegistrationRequestModel, response: Response): Optional<RegistrationResult>
    {
        ...
        val confirmData = autoLoginManager.prepareAutoLoginNonce(
                AccountAttributes.of(UUID.randomUUID().toString(), model.userName))
                .orElseThrow {
